# Contributing to Django Product Workflow


We’re excited that you’re interested in contributing to `dj-product-workflow`! Whether you’re fixing a bug, adding a feature, or improving the project, your help is appreciated.
...
1. **Fork the Repository:**
   ...
   Begin by forking the `dj-product-workflow` repository on GitHub. This creates your own copy where you can make changes.
...
2. **Clone Your Fork:**
   ...
   ```bash
   git clone https://github.com/your-username/dj-product-workflow.git
   cd dj-product-workflow
   ```
...
For linting, `pylint` is used to enforce style and catch potential errors:
   ...
   ```bash
   poetry run pylint product_workflow
   ```
...
3. **Open a Pull Request:**
   ...
   Go to the original `dj-product-workflow` repository and open a pull request. Include a detailed description of your changes and link any related issues.
...
1. **Open an Issue:**
   ...
   Head over to the `Issues` section of the `dj-product-workflow` repository and click "New Issue".
...
Thank you for your interest in contributing to `dj-product-workflow`! We look forward to your contributions.
